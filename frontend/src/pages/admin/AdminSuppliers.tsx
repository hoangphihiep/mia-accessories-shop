...
export default function AdminSuppliers() {
  ...
  return (
    <div className="relative flex w-full h-[calc(100vh-6rem)] overflow-hidden">
                ...
                <td className="p-5 pl-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      {sup.address && (
                        <span className="text-[11px] font-medium text-gray-400 truncate max-w-[200px] block">
                          {sup.address}
                        </span>
                      )}
                    </div>
      ...
      {/* Side Drawer Content */}
      <div 
        className={`fixed top-0 right-0 h-screen w-full lg:w-[500px] bg-white shadow-2xl border-l border-gray-100 z-50 transform transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] flex flex-col ${
