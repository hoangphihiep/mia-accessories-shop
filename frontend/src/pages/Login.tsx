    ...
    <div className="min-h-screen flex w-full">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-gray-900">
        ...
        <div className="absolute bottom-12 left-12 text-white max-w-lg">
          <h2 className="text-4xl font-serif mb-4">Khám phá vẻ đẹp đích thực.</h2>
            ...
            <div className="mt-8">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-gray-500 uppercase tracking-widest text-xs">Hoặc tiếp tục với</span>
                </div>
              </div>
